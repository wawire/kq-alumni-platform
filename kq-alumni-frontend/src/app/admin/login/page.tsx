    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-navy-900 via-navy-800 to-navy-900 px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-24 h-24  rounded-tl-sm rounded-tr-2xl rounded-br-sm rounded-bl-2xl mb-4 p-3">
            <Image
          ...
          <h1 className="text-3xl font-cabrito font-bold text-white mb-2">Admin Login</h1>
          <p className="text-gray-400 font-roboto">Kenya Airways Alumni Association</p>
        </div>
        ...
        <div className="bg-white rounded-tl-sm rounded-tr-2xl rounded-br-sm rounded-bl-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            {/* Username Field */}
            <div>
              <label htmlFor="username" className="block text-sm font-medium text-kq-dark mb-2">
                Username
              </label>
              <input
                {...register('username')}
            ...
            {/* Password Field */}
            <div>
              <label htmlFor="password" className="block text-sm font-medium text-kq-dark mb-2">
                Password
              </label>
